...
const iconMap: { [key: string]: React.ReactNode } = {
  TruckIcon: <LocalShipping />,
  MagnifyingGlassIcon: <Search />,
  ArrowRightIcon: <TrendingUp />,
  UserIcon: <Person />,
  ArrowPathIcon: <Build />,
  DocumentTextIcon: <Description />,
  DocumentDuplicateIcon: <Assignment />,
  ArrowUpIcon: <TrendingUp />,
  ClipboardDocumentCheckIcon: <CheckCircle />,
  ShieldCheckIcon: <Security />,
  SpeakerWaveIcon: <Business />,
  CogIcon: <Build />,
  ExclamationTriangleIcon: <Warning />,
  UserPlusIcon: <AccountBox />,
};
